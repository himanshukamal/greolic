  ...
  return (
    <div className="">
      ...
      >
        <div className="mx-2">
          <LazyLoadImage
            src="/creditcard.svg"
            alt="creditcard"
            className="left-0 top-3 mx-auto shadow-lg rounded-[40px]"
          />
        </div>
      ...
      <div className=" mt-4 flex gap-2 overflow-x-auto noscrollbar mx-auto py-4 w-[100%] max-w-[425px]">
        <div className="flex gap-2 overflow-x-scroll mx-2 noscrollbar py-4">
          <div className=" text-center font-bold text-[12px] text-white w-[142px] h-[142px] min-w-[142px] rounded-[40px] bg-gradient-to-br from-[#AD37E0] to-[#EE2B3B] grid place-items-center shadow-lg shadow-rose-500 p-8">
            <LazyLoadImage
      ...
      <div
        className={` bg-[#252525] mt-8 flex relative ${
          width < 321 ? "h-[150px]" : "h-[200px]"
        }`}
      >
