    ...
    <>
      <div>
        ...
        <Modal open={open} onClose={handleClose}>
          <div className="relative rounded-[50px] modal-content w-full max-w-[400px] min-h-[512px]  bg-white p-2  top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            ...
            <div className=" absolute z-50 top-16 left-0 ">
              ...
              <img src="/images/sryChar.png" alt="" className="m-auto h-[324px] " />
            </div>
